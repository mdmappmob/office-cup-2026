  ...
  return (
    <div className="max-w-5xl mx-auto px-8 py-10">
      <header className="mb-8">
        ...
        <p className="text-sm text-muted-foreground">Classificação geral dos participantes do bolão.</p>
      </header>

      <Card>
        <CardHeader>
          <CardTitle className="text-sm font-mono uppercase tracking-widest text-muted-foreground">Bolão da Diretoria 2026</CardTitle>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className="w-12 font-mono text-[10px] uppercase tracking-widest">Pos</TableHead>
                <TableHead className="font-mono text-[10px] uppercase tracking-widest">Membro</TableHead>
                <TableHead className="font-mono text-[10px] uppercase tracking-widest">Status</TableHead>
                <TableHead className="text-right font-mono text-[10px] uppercase tracking-widest">Pontos</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {sorted.map((m, idx) => {
                ...
                return (
                  <TableRow key={m.id} className={isMe ? "bg-primary/5" : ""}>
                    ...
                    <TableCell className="text-right font-mono font-bold">{m.total_points}</TableCell>
                  </TableRow>
                );
              })}
            </TableBody>
